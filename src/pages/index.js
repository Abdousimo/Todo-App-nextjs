...
export default function Home() {
  ...
  return (
    <section>
        ...
        <section>
          <div className={mode ? "absolute top-0 left-0 right-0 bottom-0 z-10 w-full bg-[#5b475b] m-0" : "absolute top-0 left-0 right-0 bottom-0 z-10 w-full m-0"}>
              <img 
              ...
              />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex flex-col items-center justify-center z-100 pb-12">
