...
export default function Home() {
  ...
  return (
    <section>
        ...
        <section>
          <div className={mode ? "absolute top-0 left-0 right-0 bottom-0 z-10 w-full bg-[#3C303C]" : "absolute top-0 left-0 right-0 bottom-0 z-10 w-ful"}>
              <img 
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex flex-col items-center justify-center z-100">
                    <div className="w-full max-w-[350px] sm:max-w-[600px] md:max-w-[800px] flex items-center justify-between px-3">
                    ...
                    <div className={`w-full h-10 max-w-[350px] sm:max-w-[600px] md:max-w-[800px] px-4 py-8 flex items-center justify-between rounded-b-lg shadow-lg mb-8 border-t-2 border-gray-400 ${mode ? 'bg-[#3C303C] shadow-gray-500' : 'bg-white shadow-gray-300'}`}>
                    ...
                    <div className={mode ? "h-[6vh] w-full max-w-[350px] sm:max-w-[600px] md:max-w-[800px] flex items-center justify-between rounded-lg px-8 text-xl bg-[#3C303C] shadow-lg shadow-gray-500"
